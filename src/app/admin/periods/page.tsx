    ...
    <div className="flex min-h-screen bg-brand-50">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-4xl mx-auto text-center mt-20">
          <CalendarRange className="w-16 h-16 text-brand-200 mx-auto mb-4" />
          <h1 className="text-2xl font-heading font-bold text-brand-900 mb-2">Периоды</h1>
          <p className="text-gray-400">Раздел в разработке. Здесь будет управление расчётными периодами.</p>
        </div>
      </main>
    </div>
  )
